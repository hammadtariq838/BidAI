...
const Screen = () => {
  ...
  const { data: tenderData, isLoading } = useGetTenderByIdQuery({ id, pay_item });
      ...
      {isLoading ?
        ...
        <>
          ...
          <div className="flex items-end gap-[100px]">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button className='bg-[#023047] w-max'>
                  Generate Bid
                </Button>
              </DialogTrigger>
          ...
          <div className="flow-root">
            <div className="relative overflow-y-auto max-h-[400px] max-w-[900px] rounded-lg border w-full scroll-smooth">
              <Table tender={tender} />
            </div>
          </div>
